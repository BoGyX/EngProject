...
function getDisplayedDeckCardCount(totalCards: number, loadedCardsCount: number) {
                ...
                <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                  ...
                  <div className="grid gap-3 sm:grid-cols-3 xl:min-w-[360px]">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-sm">
                      ...
                      <p className="mt-2 text-3xl font-bold text-text-light">
                        {getDisplayedDeckCardCount(selectedDeckPresentation.totalCards, cards.length)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex flex-col gap-4 rounded-2xl border border-rose-100 bg-gradient-to-r from-rose-50 to-orange-50 p-5 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-base text-slate-600">
                      {'\u041E\u0434\u043D\u0430 \u0441\u0435\u0441\u0441\u0438\u044F \u0431\u0435\u0440\u0435\u0442 \u0434\u043E 10 \u0441\u043B\u043E\u0432 \u0438\u0437 \u0442\u0435\u043A\u0443\u0449\u0435\u0433\u043E \u043F\u043E\u0434\u043A\u0443\u0440\u0441\u0430. \u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u0438\u0434\u0435\u0442 \u0437\u043D\u0430\u043A\u043E\u043C\u0441\u0442\u0432\u043E \u0441 \u044D\u0442\u0438\u043C\u0438 \u0441\u043B\u043E\u0432\u0430\u043C\u0438, \u0430 \u043F\u043E\u0442\u043E\u043C \u0442\u0440\u0435\u043D\u0438\u0440\u043E\u0432\u043A\u0430 \u0442\u043E\u043B\u044C\u043A\u043E \u044D\u0442\u0438\u0445 \u0436\u0435 \u0441\u043B\u043E\u0432. \u0414\u043B\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0439 \u0434\u0435\u0441\u044F\u0442\u043A\u0438 \u043D\u0443\u0436\u043D\u043E \u0437\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C \u043D\u043E\u0432\u0443\u044E \u0441\u0435\u0441\u0441\u0438\u044E.'}
                    </p>
                  </div>
                  <button
                    type="button"
                  ...
                  <div className="rounded-[28px] border border-gray-200 bg-card-light p-6 shadow-md">
                    ...
                    <div className="grid gap-4 xl:grid-cols-2">
                      {selectedDeckCards.regular.map((card) => (
                        <div key={card.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 transition-all hover:border-link-light hover:shadow-sm">
                          <div className="flex items-start justify-between gap-4">

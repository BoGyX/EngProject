                ...
                <div className="mt-6 flex flex-col gap-4 rounded-2xl border border-rose-100 bg-gradient-to-r from-rose-50 to-orange-50 p-5 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-base text-slate-600">
                      После каждого ответа открывается следующее слово. Если ответ неверный,
                      этот режим вернется уже в новой сессии, а в текущей слово сможет встретиться только в другом режиме.
                    </p>
                  </div>
                  <button
                    type="button"

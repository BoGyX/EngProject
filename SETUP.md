...
- для полностью открытого встраивания в `iframe` оставьте `ALLOW_IFRAME_EMBED=true` и пустой `IFRAME_ANCESTORS`; если понадобится ограничить родителей, укажите конкретный домен
